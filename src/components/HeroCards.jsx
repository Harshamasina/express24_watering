        ...
        <div className='hero_cards'>
            <div className='hero_card'>
                ...
                <div className='hero_card_info'>
                    ...
                    <span><Link className="link_button" to="/waterdamage">Learn More</Link></span>
                </div>
            </div>
            ...
            <div className='hero_card'>
                ...
                <div className='hero_card_info'>
                    ...
                    <span><Link className="link_button" to="/floodandfire">Learn More</Link></span>
                </div>
            </div>
            ...
            <div className='hero_card'>
                ...
                <div className='hero_card_info'>
                    ...
                    <span><Link className="link_button" to="/mold">Learn More</Link></span>
                </div>
            </div>
        </div>
    )
